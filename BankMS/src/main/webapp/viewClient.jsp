...
<div class="container"> 
  ...
  <div class="container-fluid">
    ...
    <form method="POST" modelAttribute="viewClient"  action="${contextPath}/viewClient" class="form-signin" >  
    ...
    <p> Identity card number:</p>
    	<input name="identityCardNumber"  type="number"  class="form-control" value="${viewClient.getIdentityCardNumber()}"  placeholder="identity card number"
                   autofocus="true"/>
    <p> CNP:</p>
    	<input name="cnp"   type="text"  class="form-control"  value="${viewClient.getCnp()}" placeholder="CNP"
                   autofocus="true"/> 
    <p> Address:</p>
