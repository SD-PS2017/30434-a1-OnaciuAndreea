...
<div class="container"> 
  ...
  <div class="container-fluid">
    ...
    <form method="POST" modelAttribute="addClient"  action="${contextPath}/employee" class="form-signin" >  
    <p>Insert name:
    	<input name="name"  type="text" type="text" value=" " class="form-control" placeholder="Username"
                   autofocus="true" /></p>
    <p>Insert password:</p>
    	<input name="identityCardNumber"  type="text" type="text" value=" " class="form-control" placeholder="Password"
                   autofocus="true"/>
    <p>Insert CNP:</p>
    	<input name="cnp"  type="text" type="text" value=" " class="form-control" placeholder="Name"
                   autofocus="true"/> 
    <p>Insert address:</p>
    	<input name="address"  type="text" value=" " class="form-control" placeholder="Salary"
                   autofocus="true"/>
                   <p></p>       
