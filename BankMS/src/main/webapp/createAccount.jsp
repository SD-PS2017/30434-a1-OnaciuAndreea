...
<div class="container"> 
  ...
  <div class="container-fluid">
    ...
    <a href="${contextPath}/login"> <button class="btn btn-danger navbar-btn">
        ...
        <form method="POST" modelAttribute="createAccount"  action="${contextPath}/createAccount" class="form-signin" >    
    ...
    <p>  Money:</p>
    	<input name="money"  type="number" value="0" class="form-control"  placeholder="money"
                   autofocus="true"/>
    
                   <button class="btn btn-lg btn-primary btn-block" type="submit">Save account</button>   
