...
<div class="container"> 
  ...
  <div class="container-fluid">
    ...
    <p>Insert identity card number:</p>
    	<input name="identityCardNumber"  type="text" type="text"  class="form-control" placeholder="identity card number"
                   autofocus="true"/>
    <p>Insert CNP:</p>
    	<input name="cnp"  type="text" type="text"  class="form-control" placeholder="CNP"
                   autofocus="true"/> 
    <p>Insert address:</p>
