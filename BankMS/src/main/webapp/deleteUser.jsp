...
<div class="container"> 
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="${contextPath}/deleteUser" onclick="myFunction()">Delete user</a></li>
    ...
    <form method="POST" modelAttribute="deleteUser"  action="${contextPath}/deleteUser" class="form-signin">  
 ...
 <form name="dUser" id="dUser" method="POST" modelAttribute="deleteUser"  action="${contextPath}/deleteUser" class="form-signin">  
    <p> Username:
    ...
    <p>Password:</p>
    	<input name="password"  type="text" type="text" value="${userToDelete.getPassword()}" class="form-control" placeholder="Password"
                   autofocus="true"/>
    	<input name="name"  type="hidden" value="${userToDelete.getName()}" class="form-control" placeholder="Name"
                   autofocus="true"/> 
                   <p></p>
    <p>Salary:</p>
    	<input name="salary"  type="number" value="${userToDelete.getSalary()}" class="form-control" placeholder="Salary"
                   autofocus="true"/>
                   <p></p>       
         <button class="btn btn-lg btn-primary btn-block" type="submit">Delete employee</button>      
    </form>
