...
<div class="container"> 
  ...
  <div class="container-fluid">
    ...
    <a href="${contextPath}/login"> <button class="btn btn-danger navbar-btn">
        ...
        <form method="POST" modelAttribute="transferMoney"  action="${contextPath}/transferMoney" class="form-signin" >    
		Insert CNP:
    	...
    	<p></p>
        From:
    	<input name="fromId"   type="number"  class="form-control" placeholder="Source account"
                   autofocus="true"/> 
                   
    	<p></p>
    	To:
    	<input name="toId"   type="number"  class="form-control" placeholder="Destination account"
                   autofocus="true"/> 
         
    	<p></p>
        Sum:
    	<input name="money"   type="number"  class="form-control" placeholder="Sum"
                   autofocus="true"/> 
